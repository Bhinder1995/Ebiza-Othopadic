...
const jsonStr = content.replace('export const PRODUCTS = ', '').replace(/;\s*$/, '');
const products = JSON.parse(jsonStr);

// Identical dictionary from apply_audited_catalog.js
const auditedCatalog = {
  ...
  "EA-06": { name: "Ash Brace (Hyper Extension Brace)", mrp: "1,700.00", sizes: "UNI" },
  ...
  "EA-14": { name: "Orthopaedic Backrest", mrp: "1,700.00", sizes: "UNI" },
  ...
  "EB-05": { name: "Cervical Pillow (Regular)", mrp: "1,275.00", sizes: "UNI" },
  ...
  "EE-10": { name: "De-Rotation Shoe", mrp: "400.00", sizes: "UNI" },
  "EE-11": { name: "AFO Night Splint", mrp: "4,000.00", sizes: "UNI" },
  ...
  "EF-04": { name: "Neoprene Knee Support with Hinges", mrp: "1,575.00", sizes: "UNI" },
  "EF-05": { name: "Drytex Knee Support", mrp: "595.00", sizes: "UNI" },
  ...
  "EF-10": { name: "R.O.M. Knee Brace", mrp: "2,750.00", sizes: "UNI" },
  ...
  "EJ-02": { name: "Exercising Ball (Sponge)", mrp: "75.00", sizes: "UNI" },
  ...
  "EJ-05": { name: "Hand Exerciser Spike Ball", mrp: "570.00", sizes: "UNI" },
  "EJ-06": { name: "Finger Exerciser", mrp: "325.00", sizes: "Blue Soft, Green Medium, Orange Hard" },
  "EJ-07": { name: "Balance Pad Square", mrp: "3,700.00", sizes: "UNI" },
  "EJ-08": { name: "Gel Ball Oval", mrp: "1,100.00", sizes: "UNI" },
  "EJ-09": { name: "Flex Bar", mrp: { "Red": "5,500.00", "Yellow": "4,150.00", "Green": "5,600.00", "Blue": "6,750.00" }, sizes: "Red, Yellow, Green, Blue" },
  "EJ-10": { name: "Hand Exerciser", mrp: "300.00", sizes: "UNI" },
  "EJ-11": { name: "Adjustable Hand Gripper", mrp: "500.00", sizes: "UNI" },
  "EJ-12": { name: "Stability Trainer Theraband", mrp: "12,000.00", sizes: "UNI" },
  ...
  "EJ-15": { name: "Moist Head Pad Set", mrp: "2,100.00", sizes: "UNI" },
  "EJ-16": { name: "V-Shape Hand Grip", mrp: "150.00", sizes: "UNI" },
  "EJ-17": { name: "Feeding Bottle", mrp: "100.00", sizes: "125 ML" },
  "EJ-18": { name: "Eye Mask Neonatal", mrp: "350.00", sizes: "UNI" },
  ...
  "EK-01": { name: "Single Stick Black (Mono Pod)", mrp: "580.00", sizes: "UNI" },
  "EK-02": { name: "Single Stick Green (Mono Pod)", mrp: "695.00", sizes: "UNI" },
  "EK-03": { name: "Tripod Stick", mrp: "975.00", sizes: "UNI" },
  "EK-04": { name: "Quadripod Stick", mrp: "975.00", sizes: "UNI" },
  "EK-05": { name: "Elbow Crutches", mrp: "1,075.00", sizes: "UNI" },
  "EK-06": { name: "Auxiliary Crutches", mrp: "1,650.00", sizes: "UNI" },
  "EK-07": { name: "Walker With Wheel", mrp: "2,250.00", sizes: "UNI" },
  "EK-08": { name: "Walker Without Wheels", mrp: "2,000.00", sizes: "UNI" },
  "EK-09": { name: "Reciprocal Walker", mrp: "3,100.00", sizes: "UNI" },
  "EK-10": { name: "Walking Frame CRC With Wheel", mrp: "2,550.00", sizes: "UNI" },
  "EK-11": { name: "Walking Frame CRC Without Wheel", mrp: "2,240.00", sizes: "UNI" },
  "EK-12": { name: "Commode Chair", mrp: "2,500.00", sizes: "UNI" },
  "EK-13": { name: "Commode Stool With Pot", mrp: "1,650.00", sizes: "UNI" },
  "EK-14": { name: "Commode Stool", mrp: "1,650.00", sizes: "UNI" },
  "EK-15": { name: "Commode Chair Height Adj. With Wheel", mrp: "5,800.00", sizes: "UNI" },
  "EK-16": { name: "Commode Chair Height Adj. Without Wheel", mrp: "5,400.00", sizes: "UNI" },
  "EK-17": { name: "Bed Back Rest", mrp: "2,000.00", sizes: "UNI" },
  "EK-18": { name: "Bed Back Rest With Handle", mrp: "2,500.00", sizes: "UNI" },
  "EK-19": { name: "Wheel Chair", mrp: "10,000.00", sizes: "UNI" },
  "EK-20": { name: "Special Wheel Chair", mrp: "12,500.00", sizes: "UNI" },

  // EL Series (Allied Products)
  "EL-01": { name: "Portable Soft Stretcher", mrp: "3,000.00", sizes: "UNI" },
  "EL-02": { name: "Trolley Cover", mrp: "2,500.00", sizes: "UNI" },
  "EL-03": { name: "Donut Cushion", mrp: "1,450.00", sizes: "Grey, Blue" },
  "EL-04": { name: "Coccyx Cushion", mrp: "1,450.00", sizes: "Grey, Blue" },
  "EL-05": { name: "Heating Pad with Regulator", mrp: "1,395.00", sizes: "UNI" },
  "EL-06": { name: "Heating Pad with Regulator", mrp: "975.00", sizes: "UNI" },
  "EL-07": { name: "Heating Pad with Switch", mrp: "499.00", sizes: "UNI" },
  "EL-08": { name: "Steam Inhalation Pot (Vaporizer)", mrp: "655.00", sizes: "UNI" },
  "EL-09": { name: "Steam Inhalation Pot With Switch", mrp: "755.00", sizes: "UNI" },
  "EL-10": { name: "Bed Pan Special", mrp: "499.00", sizes: "UNI" },
  "EL-11": { name: "Bed Pan Normal", mrp: "230.00", sizes: "UNI" },
  "EL-12": { name: "Urine Pot Male", mrp: "160.00", sizes: "UNI" },
  "EL-13": { name: "Urine Pot Female", mrp: "160.00", sizes: "UNI" },
  "EL-14": { name: "Urine Pot Unisex", mrp: "190.00", sizes: "UNI" },
  "EL-15": { name: "Sputum Pot", mrp: "110.00", sizes: "UNI" },
  ...
  "EL-20": { name: "Spirometer", mrp: "499.00", sizes: "UNI" },
  "EL-21": { name: "Digital Thermometer", mrp: "222.00", sizes: "UNI" },
  "EL-22": { name: "Oval Thermometer", mrp: "N/A", sizes: "UNI" },
  "EL-23": { name: "Digital Weight Machine", mrp: "2,150.00", sizes: "UNI" },
  "EL-24": { name: "Hot Water Bag", mrp: { "500 ML": "199.00", "2 Litre": "325.00", "2.5 Litre": "375.00" }, sizes: "500 ML, 2 Litre, 2.5 Litre" },
  "EL-25": { name: "B.P. Machine Digital", mrp: "N/A", sizes: "UNI" },
  "EL-26": { name: "B.P. Machine Manual", mrp: "N/A", sizes: "UNI" },
  "EL-27": { name: "Electric Hot Pack", mrp: "599.00", sizes: "UNI" },
  "EL-28": { name: "Stethoscope", mrp: "N/A", sizes: "UNI" },
  "EL-29": { name: "Nebulizer", mrp: "N/A", sizes: "UNI" },
  "EL-30": { name: "Pulse Oximeter", mrp: "N/A", sizes: "UNI" },
  "EL-31": { name: "Breast Pump Machine", mrp: "N/A", sizes: "UNI" },
  "EL-32": { name: "Rubber Sheet (Ordinary 1 Mtr)", mrp: { "Ordinary": "250.00", "Special": "300.00" }, sizes: "Ordinary, Special" },
  "EL-33": { name: "Dead Body Cover", mrp: "850.00", sizes: "UNI" },
  "EL-34": { name: "Oxygen Cylinder Cover", mrp: "500.00", sizes: "UNI" },
  "EL-35": { name: "Foam Air Cushion", mrp: "3,500.00", sizes: "UNI" },
  ...
  "EL-37": { name: "Hot & Cold Ice Bag Caretouch", mrp: "299.00", sizes: "UNI" },
  "EL-38": { name: "Anesthetic Face Mask", mrp: "250.00", sizes: "UNI" },
  "EL-39": { name: "Air Mattress", mrp: "5,500.00", sizes: "UNI" },
  "EL-40": { name: "Patients Welcome Kit", mrp: "300.00", sizes: "UNI" },
  ...
  "EM-10": { name: "AFO Night Splint -- Child", mrp: "3,500.00", sizes: "UNI" }
};

// Check differences
let differencesReport = 'AUDIT DIFFERENCES REPORT\n\n';
let diffCount = 0;

for (const code in products) {
  const current = products[code];
  const audited = auditedCatalog[code];
  
  if (!audited) {
    differencesReport += `[REDUNDANT / NOT IN AUDITED LIST]: ${code} (${current.name})\n`;
    diffCount++;
    continue;
  }
  ...
  if (JSON.stringify(current.mrp) !== JSON.stringify(audited.mrp)) {
    pDiff = true;
  }
  if (current.sizes !== audited.sizes) {
    sDiff = true;
  }
  if (current.name !== audited.name && audited.name) {
    nDiff = true;
  }
  
  if (pDiff || sDiff || nDiff) {
    differencesReport += `${code} (${current.name}):\n`;
    if (nDiff) differencesReport += `  NAME:  "${current.name}" -> "${audited.name}"\n`;
    if (sDiff) differencesReport += `  SIZES: "${current.sizes}" -> "${audited.sizes}"\n`;
    if (pDiff) differencesReport += `  MRP:   ${JSON.stringify(current.mrp)} -> ${JSON.stringify(audited.mrp)}\n`;
    differencesReport += '\n';
    diffCount++;
  }
}
...
for (const code in auditedCatalog) {
  if (!products[code]) {
    differencesReport += `[MISSING PRODUCT IN products.js]: ${code} (${auditedCatalog[code].name})\n\n`;
    diffCount++;
  }
}

differencesReport += `Total differences found: ${diffCount}\n`;
fs.writeFileSync('diff_report.txt', differencesReport, 'utf8');
console.log("Diff report written to diff_report.txt");
